        ...
        <AnimatePresence>
            {isModalOpen && (
                <motion.div
                    ...
                    className={`modal-container z-50 bottom-0 lg:bottom-auto ${modalHeight} h-[47%] sm:w-[75%]  sm:h-[40%] lg:h-[80%] lg:w-[40%] sm:left-[12%] p-4 sm:p-8 lg:p-12 xl:p-12 overflow-hidden`}
                    style={{
                        background: "#fff",
                        borderRadius: "8px",
                        position: "fixed",

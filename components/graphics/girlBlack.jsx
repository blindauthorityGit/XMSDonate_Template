...
// FUNCTIONS
import getPercentageOfViewportHeight from "../../functions/getPercentageOfViewportHeight";
...
const GirlBlackGraphic = () => {
    ...
    useEffect(() => {
        ...
        const handleResize = () => {
            ...
            console.log(getPercentageOfViewportHeight(28));
        };
    ...
    return (
        <>
            <CoverImage
                ...
                className="z-30 lg:z-[10] bottom-[28%] sm:bottom-[20%] lg:bottom-[5%] xl:top-auto xl:bottom-[5%] left-[10%] sm:left-[12%] lg:left-[10%] xl:left-[12%] w-[22vw] md:w-[18vw] lg:w-[auto] lg:h-[25vh] h-auto xl:w-[auto] xl:h-[25vh]"
            />
        </>
    );
};

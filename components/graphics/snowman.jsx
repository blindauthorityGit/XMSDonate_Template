    ...
    return (
        <>
            <CoverImage
                ...
                className="z-30 lg:z-[20] top-[56%] sm:top-[auto] right-[6%] sm:right-[10%] lg:right-[35%] lg:top-auto sm:bottom-[23%] lg:bottom-[14%] xl:bottom-[130px] xl:right-[34%] w-[13vh] h-[auto] xl:w-[213px] xl:h-[auto]"
            />
        </>
    );
};
